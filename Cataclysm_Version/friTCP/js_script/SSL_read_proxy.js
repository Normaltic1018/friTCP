...
var hook_module_name = "libssl-1_1.dll";
var hook_function_name = "SSL_read";
...
Interceptor.attach(hookPtr,{
	...
	onLeave: function(retVal){
		...
		// Buffer Information
		var buf_addr = ptr(this.buf);
	
		var buf_length = retVal.toInt32();
		
		var res = hexdump(buf_addr,{offset:0,length:buf_length,header:false,ansi:false});
