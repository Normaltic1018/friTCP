...
def print_info():
	if(console_mode):
		...
		#cmd_sock.send("version:{}".format(version))

		#print("2[SETTING]:"+str(settings))
		#cmd_sock.send("[SETTING]:"+str(settings))

		#print("3[SETTING]:"+str(commands))
		#cmd_sock.send("[SETTING]:"+str(commands))
                cmd_sock.send('{"type":"boot","data":{"service":"init","res":"success","message":"core init success"}}')
